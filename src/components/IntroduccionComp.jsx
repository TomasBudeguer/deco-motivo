  ...
  return (
    <div class="relative isolate overflow-hidden px-6 py-24 sm:py-32 lg:overflow-visible lg:px-0 bg-neutral-100">
      ...
      <div class="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 lg:mx-0 lg:max-w-none lg:grid-cols-2 lg:items-start lg:gap-y-10">
        ...
        <div
          class="-ml-12 -mt-12 p-12 mx-auto lg:sticky lg:top-4 lg:col-start-2 lg:row-span-2 lg:row-start-1 lg:overflow-hidden"
          data-aos="zoom-in-left"
        >
          <img
            class=" rounded-xl color-nav-footer shadow-xl ring-1 ring-gray-400/10 "
            src="logo-footer.png"
            alt=""
          />
        </div>
